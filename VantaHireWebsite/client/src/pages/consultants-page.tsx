        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          <div className="text-center mb-12 pt-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="text-white ml-3">Consultants</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {consultants.map((consultant) => (
              <Card key={consultant.id} className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-white text-xl mb-1">{consultant.name}</CardTitle>
                ...
                <CardContent className="space-y-4">
                  {/* Domains */}
                  <div>
                    <p className="text-white/90 text-sm font-semibold mb-2">Expertise:</p>
                  ...
                  {consultant.description && (
                    <p className="text-white/70 text-sm line-clamp-3">{consultant.description}</p>
                  )}
          ...
          {consultants.length === 0 && (
            <div className="text-center py-16">
              <p className="text-white/70 text-lg">No consultants available at the moment.</p>
            </div>
          )}
        </div>
      </div>
